...
export const products: Product[] = [
  ...
  {
    id: 'mediclinic-enterprise',
    slug: 'mediclinic-enterprise',
    name: 'MediClinic Enterprise',
    shortName: 'MediClinic',
    category: 'Healthcare Solutions',
    categorySlug: 'healthcare',
    tagline: '24/7 Smart Outpatient Medical Suite & EMR Telemetry Platform',
    description: 'An enterprise-grade smart outpatient medical center platform featuring real-time EMR telemetry, encrypted biometric MyKad registration, cashless TPA panel claim verification, and barcode-guided pharmacy compounding.',
    icon: 'Heart',
    color: 'cyan',
    image: '/product-clinical.jpg',
    modules: [
      'Real-Time EMR Telemetry',
      'Biometric MyKad Scanner',
      'Cashless TPA e-GL Gateway',
      'Compounding Pharmacy',
      'Pediatric & Immunization Suite',
    ...
    features: [
      ...
      'Instant Cashless e-GL Verification',
      'Barcode FIFO Dispensing',
      'ICD-10 Diagnostic Lookup',
      'Automated Triage Priority',
      'PDPA 2010 Encrypted',
      'Multi-branch Synchronization'
    ],
    industries: ['Outpatient Clinics', 'Medical Centers', 'Hospitals', 'Specialist Centers', 'Healthcare Groups'],
    techStack: ['React', 'Node.js', 'PostgreSQL', 'Tailwind CSS', 'Google Cloud', 'Biometric IoT API'],
    featured: true,
  },
  {
    id: 'hrms',
